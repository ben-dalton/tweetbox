...
set modelines=1
set ruler
set runtimepath=~/.vim,~/.vim/bundle/Vundle.vim,~/.vim/bundle/nerdtree,~/.vim/bundle/vim-airline,~/.vim/bundle/vim-airline-themes,~/.vim/bundle/vim-easymotion,~/.vim/bundle/delimitMate,~/.vim/bundle/jellybeans.vim,~/.vim/bundle/emmet-vim,~/.vim/bundle/ctrlp.vim,~/.vim/bundle/scss-syntax.vim,~/.vim/bundle/syntastic,~/.vim/bundle/vim-unimpaired,~/.vim/bundle/vim-fugitive,~/.vim/bundle/vim-surround,~/.vim/bundle/vim-commentary,~/.vim/bundle/vim-visual-star-search,~/.vim/bundle/vim-bbye,~/.vim/bundle/vim-vwilight,~/.vim/bundle/vim-coloresque,~/.vim/bundle/ag.vim,~/.vim/bundle/ultisnips,~/.vim/bundle/vim-fidget,~/.vim/bundle/vim-snippets,~/.vim/bundle/vim-javascript,~/.vim/bundle/vim-jsx,~/.vim/bundle/vim-react-snippets,/usr/local/Cellar/macvim/7.4-74/MacVim.app/Contents/Resources/vim/vimfiles,/usr/local/Cellar/macvim/7.4-74/MacVim.app/Contents/Resources/vim/runtime,/usr/local/Cellar/macvim/7.4-74/MacVim.app/Contents/Resources/vim/vimfiles/after,~/.vim/after,~/.vim/bundle/Vundle.vim,~/.vim/bundle/Vundle.vim/after,~/.vim/bundle/n
set scrolloff=5
set shiftwidth=2
set showmatch
set showtabline=2
...
set wildignore=*/tmp/*,*.so,*/node_modules,*.swp,*.zip,**/node_modules/**
set wildmenu
set window=44
let s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
let v:this_session=expand("<sfile>:p")
silent only
cd ~/Projects/Sandbox/tweetbox
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +18 app/assets/frontend/main.jsx
argglobal
silent! argdel *
argadd .
edit app/assets/frontend/main.jsx
...
silent! normal! zE
let s:l = 18 - ((9 * winheight(0) + 21) / 42)
